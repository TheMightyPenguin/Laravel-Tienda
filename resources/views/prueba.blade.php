...
<body id="page-top" class="index">
    ...
    <div class="well">
        ...
        <p>Nombre:   {{ $usuario2->name }}</p>
        <p>Apellido: {{ $usuario2->apellido }}</p>
        <p>Correo:   {{ $usuario2->email }}</p>
        <p>Tipo De usuario:   {{ $usuario2->tipousuario->nombre }}</p>
        <p>Estatus: {{ $usuario2->estatus->nombre }}</p>
    </div>
    ...
    @foreach($usuarios as $usuario)
        <div class="well">
            ...
            <p>Tipo De usuario:   {{ $usuario->tipousuario->nombre }}</p>
            <p>Estatus: {{ $usuario->estatus->nombre }}</p>
        </div>
    @endforeach
